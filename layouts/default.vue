          ...
          <div class="flex">
            <div class="hidden sm:ml-6 sm:flex">
              ...
              <nuxt-link
                ...
                class="ml-8 inline-flex items-center px-4 rounded py-2 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-white bg-green hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"
              >
                Register
              </nuxt-link>
              <nuxt-link
